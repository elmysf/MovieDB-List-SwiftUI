...
public class Cast: NSObject, Codable, NSSecureCoding {
    ...
    public required init?(coder: NSCoder) {
        ...
        self.creditID = coder.decodeObject(forKey: Keys.creditID.rawValue) as? String ?? ""
